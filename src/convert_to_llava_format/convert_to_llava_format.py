...
def convert_to_llava_format(module_path, output_path, central_images_dir):
...
def main():
    ...
    output_dir = os.path.join("src", "convert_to_llava_format", "llava_training_data")
    ...
    for module in os.listdir(extracted_dir):
        ...
        if os.path.isdir(module_path):
            ...
            output_file = convert_to_llava_format(module_path, output_dir, central_images_dir)
